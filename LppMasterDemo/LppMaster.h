...
bool TLpp::begin()
   {  bool r;
      ...
      if (Status.SwRevision != 2) {
         printf("Lpp.begin() failed (sw version error - %d)", Status.SwRevision);
         return false;
      }
...
//-----------------------------------------------------------------------------
// TLpp::Stop - Suspent lpp communications
//-----------------------------------------------------------------------------
// return true on succes.
//-----------------------------------------------------------------------------
bool TLpp::Stop()
...
bool TLpp::ReadStatus()
  ...
  TxBuffer[0] = 0;
      return I2cSendReceive(LPP_I2C_ADDRESS, 1, sizeof(Status), (lpp_tx_buffer *)TxBuffer, (lpp_rx_buffer *)&Status);
}
